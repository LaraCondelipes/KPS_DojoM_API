...
builder.Services.AddDbContext<KPS_DbContext>(options => 
    options.UseSqlServer(builder.Configuration.GetConnectionString("KPSDatabase") ?? throw new InvalidOperationException("Connection string 'KPS_DbContext' not found")));
